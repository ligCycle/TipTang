...
2. **คนดูเลือกตอนโดเนท** — หน้ารับทิปโชว์สวิตช์ `⏫ เพิ่มเวลา | ⏬ ลดเวลา` เฉพาะเมื่อครีเอเตอร์ **เปิด timer และเปิด reduce** ·
   **default = เพิ่มเวลา เสมอ** (ตอนเปิดหน้าและหลังส่งสำเร็จ) · ใต้สวิตช์บอกอัตราทั้งสองฝั่ง + ขั้นต่ำ · เลือก "ลด" แต่ยอด < ขั้นต่ำ →
   ปุ่มสร้าง QR ปิด + ข้อความ · เก็บใน `Tip.timerReduce Boolean default false`
